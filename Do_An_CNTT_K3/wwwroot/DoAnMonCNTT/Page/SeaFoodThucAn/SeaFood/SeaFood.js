...
var swiper = new Swiper(".mySwiper", {
    autoplay: {
        delay: 2000, // Thời gian chuyển ảnh (tính bằng mili giây)
        disableOnInteraction: false, // Tiếp tục autoplay ngay cả khi người dùng tương tác với swiper
    },
    // Các tùy chọn khác
    loop: true, // Tùy chọn để vòng lặp các slide
    speed: 1000, // Thời gian chuyển động giữa các slide (tính bằng mili giây)
});
